...
(collect-info-to-file 
  ...
  "clojure.core:clojure.core.protocols:clojure.core.reducers:clojure.data:clojure.edn:clojure.inspector:clojure.java.browse:clojure.java.io:clojure.java.javadoc:clojure.java.shell:clojure.main:clojure.pprint:clojure.reflect:clojure.repl:clojure.set:clojure.stacktrace:clojure.string:clojure.template:clojure.test:clojure.walk:clojure.xml:clojure.zip"
